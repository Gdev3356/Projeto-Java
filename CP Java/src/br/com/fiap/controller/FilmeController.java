...
public class FilmeController {
    public String inserirFilme(String titulo, String genero, String produtora) throws ClassNotFoundException, SQLException {
        ...
        FilmeDAO clienteDAO = new FilmeDAO(con);
        resultado = clienteDAO.inserir(filme);
    ...
    public String listarTodos(int codigo) throws ClassNotFoundException, SQLException {
        String resultado;
        Connection con = ConnectionFactory.abrirConexao();
        Filme filme = new Filme();
        filme.setCodigo(codigo);
        FilmeDAO clienteDAO = new FilmeDAO(con);
        resultado = clienteDAO.listarTodos(filme);
        ConnectionFactory.fecharConexao(con);
        return resultado;
    }
