...
public class Exemplo2 {
    public static void main(String[] args) {
        try {
            int num1 = Integer.parseInt(JOptionPane.showInputDialog("Digite um número inteiro (faixa permitida de 1 à 50)"));
            if (num1 < 1 || num1 > 50) {
                throw new Exception("Número informado fora da faixa permitida!");
            }
            int num2 = Integer.parseInt(JOptionPane.showInputDialog(null, "Digite outro número inteiro: "));
